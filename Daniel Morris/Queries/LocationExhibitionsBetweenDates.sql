...
SELECT * FROM LocationExhibitionsBetweenDates WHERE "Institution" = ${"Institution" ||MCA||String||where nullable unformatted ds=11 dt=STRING}$
AND "Location" = ${"Location" ||Gallery A||String||where nullable unformatted ds=11 dt=STRING}$
